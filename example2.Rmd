---
title: "SRP038101: Example2 gene set analysis: The case of Azacytidine"
author: "Mark Ziemann"
date: "`r Sys.Date()`"
output:
  html_document:
...
lapply(1:nrow(comb_only_df),function(i) {
  ...
  heatmap.2(as.matrix(mymx2),main=myset,trace="none",scale="row",margin=c(6,12),Colv="none",dendrogram="row",cexCol=0.8,cexRow=0.5)
