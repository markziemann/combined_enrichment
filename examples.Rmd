...
beeswarm(mresl[1:5] ,labels = rev(colnames(mres)[1:5]), pwcol = coll, cex=1.5,pch=19, add = TRUE)
...
coll <- list(cols, cols)
boxplot(mres[,6:7],col="white")
beeswarm(mresl[6:7] ,labels = rev(colnames(mres)[6:7]), pwcol = coll, cex=1.5,pch=19, add = TRUE)
