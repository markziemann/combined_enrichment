...
From 109 selected open-articles that performed ORA on differential expression data, 28 (25%) considered the up- and down-regulated 
gene lists in separate tests, while 76 (69%) performed combined analysis of up- and downregulated genes.
...
The t-test statistic distribution indicates a strong positive skew, suggesting some degree of correlation for most gene sets.
...
consistently detected a larger proportion of differentially regulated gene sets.
